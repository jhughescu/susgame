...
templates['slide_110_stakeholders'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <div class=\"cell\">"
    + ((stack1 = container.invokePartial(lookupProperty(partials,"stakeholder_card"),depth0,{"name":"stakeholder_card","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "</div>\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
  ...
  return ((stack1 = container.invokePartial(lookupProperty(partials,"frame1full"),depth0,{"name":"frame1full","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "<div class='container'>\n    <table class='stakeholders'><tbody>\n        <tr><td>"
    + ((stack1 = container.invokePartial(lookupProperty(partials,"stakeholder_card"),depth0,{"name":"stakeholder_card","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + ((stack1 = container.invokePartial(lookupProperty(partials,"stakeholder_card"),depth0,{"name":"stakeholder_card","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + ((stack1 = container.invokePartial(lookupProperty(partials,"stakeholder_card"),depth0,{"name":"stakeholder_card","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "</td></tr>\n        <tr><td>"
    ...
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? lookupProperty(depth0,"gamedata") : depth0)) != null ? lookupProperty(stack1,"mainTeams") : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":9,"column":8},"end":{"line":11,"column":17}}})) != null ? stack1 : "")
    + "    </div>\n</div>\n";
...
templates['slide_partials/stakeholder_card'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"stakeholder_card\">\n        <div class='text header'>"
