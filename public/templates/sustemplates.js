...
templates['playerList'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n\n<table id='playerList'>\n    <tbody>\n        <tr><th>id</th><th>connected</th><th>enrolled</th><th>stakeholder</th><th>isLead</th><th>rounds</th><th></th></tr>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"players") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":6,"column":8},"end":{"line":18,"column":17}}})) != null ? stack1 : "")
    + "    </tbody>\n</table>\n";
},"useData":true});
...
templates['partials/publicvoices'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<tr><td>"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":7,"column":103},"end":{"line":7,"column":109}}}) : helper)))
    + "' style='width: 40px;' oninput='validateVote(this)' type='number' value='0'><button class='buttonVote' id='buttonVote_"
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":7,"column":227},"end":{"line":7,"column":233}}}) : helper)))
    + "'>Submit</button></td></tr>";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
...
templates['slides/slide_partials/stakeholder_card'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class='stakeholder_card' id='stakeholder_card_"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"resource") || (depth0 != null ? lookupProperty(depth0,"resource") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"resource","hash":{},"data":data,"loc":{"start":{"line":10,"column":35},"end":{"line":10,"column":47}}}) : helper)))
