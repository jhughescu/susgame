...
templates['partials/stakeholder'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<p>Role: Stakeholder Team "
    ...
    + "</p>\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"isLead") : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":2,"column":0},"end":{"line":27,"column":7}}})) != null ? stack1 : "")
    + "\n<script>\n    setupStakeholder();\n</script>\n";
},"useData":true});
